...
import SectionAuth          from 'app/default/auth/web/section/SectionAuth'
import SectionNotify        from 'app/default/notify/web/section/SectionNotify'
...
const PageEnter = () => {
  return (
    <Page hasFooter>
      ...
      <SectionAuth theme={theme.default}/>
